...
const Hero = () => {
  return (
    <section
      id="home"
      className="pt-28 pb-20 md:py-36 min-h-screen flex items-center bg-gradient-to-b from-portfolio-secondary/20 to-white overflow-hidden"
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              Hi, I'm <span className="text-portfolio-primary">Iman</span>{" "}
              <br />
              Olabode Bello
            </motion.h1>
            <motion.p
            ...
            >
              Full-stack engineer crafting pixel-perfect UIs and scalable
              back-ends with React, React-Native, TypeScript, Express.Js and
              Spring Boot turning ideas into fluid, human-centered experiences.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                ...
                <ArrowRight
                  size={18}
                  className="ml-2 transform group-hover:translate-x-1 transition-transform duration-500"
                />
              </motion.a>
              <motion.a
                whileHover={{ scale: 1.05 }}
            ...
            >
              {[
                {
                  icon: "/lovable-uploads/442bdbda-2fb9-485d-8240-c9266afa143c.png",
                ...
                >
                  <span className="opacity-60 hover:opacity-100 transition-opacity duration-500">
                    {link.label}
                  </span>
                </motion.a>
              ))}
